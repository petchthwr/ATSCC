...
def create_row_gaussian_weight(size, center_index, sigma=1, device=None):
    """
    Create a row of Gaussian weights of the given size with the Gaussian distribution
    centered at the specified index, using PyTorch tensors.
    """
...
def find_closest_indices(split_indices, target_index):
    """
    Find the closest index in the split_indices to the target_index.

    :param split_indices: Tensor of indices where the label changes.
    :param target_index: The target index.
    :return: The closest index from split_indices to the target_index.
    """
...
def gaussian_weight_matrix(proc_label, min2sigma=20.0):
    """
    Create a matrix of Gaussian weights for the given labels.

    :param proc_label: List of labels.
    :return: Matrix of Gaussian weights.
    """
